...
#define __USBD_DESC_H
  ...
  */
    ...
    #define USBD_BB_IF_STR_DESC           (uint8_t *)"AirMCU BillBoard Interface"
    #define USBD_BB_URL_STR_DESC          (uint8_t *)"www.st.com"
    #define USBD_BB_ALTMODE0_STR_DESC     (uint8_t *)"AirMCU Alternate0 Mode"
    #define USBD_BB_ALTMODE1_STR_DESC     (uint8_t *)"AirMCU Alternate1 Mode"
  #endif
